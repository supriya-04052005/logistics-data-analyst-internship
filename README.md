...
The internship focuses on applying data analytics and data science techniques to logistics problems and developing data-driven insights for operational decision-making.

---

## 📚 Weekly Projects

| Week | Project | Main Focus | Status |
|------|---------|-------------|--------|
...
│   ├── logistic_shipment_data_analysis.ipynb
│   ├── logistics_shipment_data_2000.csv
